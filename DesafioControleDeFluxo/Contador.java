...
public class Contador {
	...
	static void contar(int parametroUm, int parametroDois) {
		...
		ParametrosInvalidosException parametrosInvalidos = new ParametrosInvalidosException();
		if (parametroUm > parametroDois) {
			System.out.println(parametrosInvalidos.toString());
		}
